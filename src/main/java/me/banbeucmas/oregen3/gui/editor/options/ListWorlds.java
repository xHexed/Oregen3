...
public class ListWorlds extends ChestUI {
    ...
    public ListWorlds(Player player, MenuGenerator menuGenerator, Generator generator, int page) {
        ...
        if (Oregen3.getPlugin().getConfig().getBoolean("generators." + generator.getId() + ".world.blacklist")) {
            set(4, 5, new ItemBuilder(XMaterial.GREEN_STAINED_GLASS_PANE.parseMaterial())
                ...
                ListWorlds ui = new ListWorlds(player,
            ...
            set(4, 5, new ItemBuilder(XMaterial.RED_STAINED_GLASS_PANE.parseMaterial())
    ...
    private void renderPage() {
        ...
        for (int i = 0; i < 36; i++) {
            ...
            if (config.getStringList("generators." + generator.getId() + ".world.list").contains(world)) {
                set(i % 9, 1 + (i / 9), new ItemBuilder(XMaterial.GREEN_STAINED_GLASS_PANE.parseMaterial())
                ...
                set(i % 9, 1 + (i / 9), new ItemBuilder(XMaterial.RED_STAINED_GLASS_PANE.parseMaterial())
